...
- `control-ledger.ts` также определяет источники добровольной Defense: обычную руку игрока и зарегистрированные extension-зоны. Перемещение такой карты между физическими зонами выполняется только через операции Ledger.
