...
В отчёте Analyzer `actionCount` — сумма действий во всех найденных линиях, `choiceBranchCount` — число выбранных ветвей выбора, а `branchCount` — их сумма с терминальными линиями. Это воспроизводимый объём поиска, а не оценка времени.
