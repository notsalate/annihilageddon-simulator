...
Runtime IDs для свойств волшебников и текущего DWT-placeholder уже перенесены на set-prefixed стиль. Новый импорт должен сразу использовать новый стиль.
