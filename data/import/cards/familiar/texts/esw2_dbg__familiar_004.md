# esw2_dbg\_\_familiar_004

- source image path: `assets/cards/raw/familiar/Фамильяр. Бензопила Дружок.png`
- source label: `Фамильяр. Бензопила Дружок`
- processed marker: `manual_from_uploaded_image`
- quantity: `1`
- visible Russian name: `Бензопила «Дружок»`
...
+3 мощи
Следующей атаки, которую ты сыграешь в этот ход, нельзя избежать.
