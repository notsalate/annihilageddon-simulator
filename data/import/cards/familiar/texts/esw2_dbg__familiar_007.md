# esw2_dbg\_\_familiar_007

- source image path: `assets/cards/raw/familiar/Фамильяр. Мыжсемья.png`
- source label: `Фамильяр. Мыжсемья`
- processed marker: `manual_from_uploaded_image`
- quantity: `1`
- visible Russian name: `Мыжсемья`
...
Возьми 1 карту.
В этот ход легенды стоят на 2 дешевле.
Защита: можешь сбросить эту карту, чтобы избежать атаки.
Если сбросил, возьми 2 карты.
