...
const configuredAllowedViolations = [
  ...
  ["src/engine/data.ts", 2087, 3, "optionalNonEmptyStringField"],
  ["src/engine/data.ts", 2099, 3, "requireStringOrNullField"],
  ["src/engine/data.ts", 2114, 3, "requireExactStringField"],
  ["src/engine/data.ts", 2134, 3, "requireNumberField"],
  ["src/engine/data.ts", 2149, 3, "requireNumberOrNullField"],
  ["src/engine/data.ts", 2167, 3, "requireBooleanField"],
  ["src/engine/data.ts", 2182, 3, "requireStringArrayField"],
  ["src/engine/data.ts", 2206, 3, "requireUnsupportedMechanicsField"],
  ["src/engine/data.ts", 2235, 3, "optionalStringArrayField"],
  ["src/engine/data.ts", 2248, 3, "requireCardKindField"],
  ["src/engine/data.ts", 2263, 3, "requireTokenKindField"],
  ...
  ["src/engine/runtime-effect.ts", 443, 4, "isRuntimeEffectTargetRecord"],
];
