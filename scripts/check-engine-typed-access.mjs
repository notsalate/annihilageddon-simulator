...
const configuredAllowedViolations = [
  ["src/engine/data.ts", 1301, 3, "decodeRuntimeSourceMetadata"],
  ["src/engine/data.ts", 1705, 1, "expectRuntimeRecord"],
  ["src/engine/data.ts", 1718, 1, "requireRecordField"],
  ["src/engine/data.ts", 1719, 3, "requireRecordField"],
  ["src/engine/data.ts", 1733, 1, "optionalRecordField"],
  ["src/engine/data.ts", 1734, 3, "optionalRecordField"],
  ["src/engine/data.ts", 1753, 3, "requireArrayField"],
  ["src/engine/data.ts", 1768, 3, "requireUnknownArrayField"],
  ["src/engine/data.ts", 1778, 3, "requireRuntimeEffectArrayField"],
  ["src/engine/data.ts", 1802, 3, "optionalUnknownArrayField"],
  ["src/engine/data.ts", 1819, 3, "requireStringField"],
  ["src/engine/data.ts", 1834, 3, "optionalStringField"],
  ["src/engine/data.ts", 1853, 3, "requireNonEmptyStringField"],
  ["src/engine/data.ts", 1871, 3, "optionalNonEmptyStringField"],
  ["src/engine/data.ts", 1883, 3, "requireStringOrNullField"],
  ["src/engine/data.ts", 1898, 3, "requireExactStringField"],
  ["src/engine/data.ts", 1918, 3, "requireNumberField"],
  ["src/engine/data.ts", 1933, 3, "requireNumberOrNullField"],
  ["src/engine/data.ts", 1951, 3, "requireBooleanField"],
  ["src/engine/data.ts", 1966, 3, "optionalBooleanField"],
  ["src/engine/data.ts", 1983, 3, "requireStringArrayField"],
  ["src/engine/data.ts", 2007, 3, "requireUnsupportedMechanicsField"],
  ["src/engine/data.ts", 2036, 3, "optionalStringArrayField"],
  ["src/engine/data.ts", 2049, 3, "requireCardKindField"],
  ["src/engine/data.ts", 2064, 3, "requireTokenKindField"],
  ["src/engine/data.ts", 2089, 3, "validateRuntimeEffectDefinition"],
  ["src/engine/data.ts", 2110, 43, "isEffectRecord"],
