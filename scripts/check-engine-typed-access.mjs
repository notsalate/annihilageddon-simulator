...
const configuredAllowedViolations = [
  ...
  ["src/engine/runtime-effect-decoder.ts", 861, 41, "isPlainRecord"],
  ["src/engine/runtime-effect.ts", 1059, 4, "isRuntimeEffectTargetRecord"],
  ["src/engine/runtime-effect.ts", 1064, 3, "hasExactKeys"],
];
