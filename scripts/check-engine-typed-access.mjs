...
const configuredAllowedViolations = [
  ...
  ["src/engine/runtime-effect-decoder.ts", 848, 41, "isPlainRecord"],
  ["src/engine/runtime-effect.ts", 1014, 4, "isRuntimeEffectTargetRecord"],
  ["src/engine/runtime-effect.ts", 1019, 3, "hasExactKeys"],
];
