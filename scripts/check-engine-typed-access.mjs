...
const configuredAllowedViolations = [
  ["src/engine/data.ts", 551, 3, "validateAttackSemanticsMapping"],
  ["src/engine/data.ts", 1350, 3, "decodeRuntimeSourceMetadata"],
  ["src/engine/data.ts", 1754, 1, "expectRuntimeRecord"],
  ["src/engine/data.ts", 1767, 1, "requireRecordField"],
  ["src/engine/data.ts", 1768, 3, "requireRecordField"],
  ["src/engine/data.ts", 1782, 1, "optionalRecordField"],
  ["src/engine/data.ts", 1783, 3, "optionalRecordField"],
  ["src/engine/data.ts", 1802, 3, "requireArrayField"],
  ["src/engine/data.ts", 1817, 3, "requireUnknownArrayField"],
  ["src/engine/data.ts", 1827, 3, "requireRuntimeEffectArrayField"],
  ["src/engine/data.ts", 1851, 3, "optionalUnknownArrayField"],
  ["src/engine/data.ts", 1868, 3, "requireStringField"],
  ["src/engine/data.ts", 1883, 3, "optionalStringField"],
  ["src/engine/data.ts", 1902, 3, "requireNonEmptyStringField"],
  ["src/engine/data.ts", 1920, 3, "optionalNonEmptyStringField"],
  ["src/engine/data.ts", 1932, 3, "requireStringOrNullField"],
  ["src/engine/data.ts", 1947, 3, "requireExactStringField"],
  ["src/engine/data.ts", 1967, 3, "requireNumberField"],
  ["src/engine/data.ts", 1982, 3, "requireNumberOrNullField"],
  ["src/engine/data.ts", 2000, 3, "requireBooleanField"],
  ["src/engine/data.ts", 2015, 3, "requireStringArrayField"],
  ["src/engine/data.ts", 2039, 3, "requireUnsupportedMechanicsField"],
  ["src/engine/data.ts", 2068, 3, "optionalStringArrayField"],
  ["src/engine/data.ts", 2081, 3, "requireCardKindField"],
  ["src/engine/data.ts", 2096, 3, "requireTokenKindField"],
  ["src/engine/data.ts", 2121, 3, "validateRuntimeEffectDefinition"],
  ["src/engine/data.ts", 2142, 43, "isEffectRecord"],
  ["src/engine/runtime-effect-decoder.ts", 77, 9, "decodeObject"],
  ["src/engine/runtime-effect-decoder.ts", 961, 41, "isPlainRecord"],
  ["src/engine/runtime-effect.ts", 1273, 4, "isRuntimeEffectTargetRecord"],
  ["src/engine/runtime-effect.ts", 1278, 3, "hasExactKeys"],
];
