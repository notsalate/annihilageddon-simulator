...
const configuredAllowedViolations = [
  ...
  ["src/engine/runtime-effect-decoder.ts", 913, 41, "isPlainRecord"],
  ["src/engine/runtime-effect.ts", 1017, 4, "isRuntimeEffectTargetRecord"],
  ["src/engine/runtime-effect.ts", 1022, 3, "hasExactKeys"],
];
