...
const configuredAllowedViolations = [
  ["src/engine/data.ts", 1623, 1, "expectRuntimeRecord"],
  ["src/engine/data.ts", 1636, 1, "requireRecordField"],
  ["src/engine/data.ts", 1651, 1, "optionalRecordField"],
  ["src/engine/data.ts", 1637, 3, "requireRecordField"],
  ["src/engine/data.ts", 1652, 3, "optionalRecordField"],
  ["src/engine/data.ts", 1671, 3, "requireArrayField"],
  ["src/engine/data.ts", 1686, 3, "requireUnknownArrayField"],
  ["src/engine/data.ts", 1696, 3, "requireRuntimeEffectArrayField"],
  ["src/engine/data.ts", 1762, 11, "requireRuntimeEffectArrayField"],
  ["src/engine/data.ts", 1966, 3, "optionalUnknownArrayField"],
  ["src/engine/data.ts", 1983, 3, "requireStringField"],
  ["src/engine/data.ts", 1998, 3, "optionalStringField"],
  ["src/engine/data.ts", 2017, 3, "requireStringOrNullField"],
  ["src/engine/data.ts", 2032, 3, "requireExactStringField"],
  ["src/engine/data.ts", 2052, 3, "requireNumberField"],
  ["src/engine/data.ts", 2067, 3, "requireNumberOrNullField"],
  ["src/engine/data.ts", 2085, 3, "requireBooleanField"],
  ["src/engine/data.ts", 2100, 3, "requireStringArrayField"],
  ["src/engine/data.ts", 2124, 3, "requireUnsupportedMechanicsField"],
  ["src/engine/data.ts", 2153, 3, "optionalStringArrayField"],
  ["src/engine/data.ts", 2166, 3, "requireCardKindField"],
  ["src/engine/data.ts", 2181, 3, "requireTokenKindField"],
  ["src/engine/data.ts", 2206, 3, "validateRuntimeEffectDefinition"],
  ["src/engine/data.ts", 2237, 3, "validateNestedAttackBranches"],
  ["src/engine/data.ts", 2290, 43, "isEffectRecord"],
